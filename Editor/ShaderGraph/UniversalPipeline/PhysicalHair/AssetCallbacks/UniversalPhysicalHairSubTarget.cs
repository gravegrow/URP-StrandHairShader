...
*/            
        ...
        static class LitIncludes
        {
            ...
            const string kForwardPass           = "Packages/URP-StrandHairShader/Editor/ShaderGraph/UniversalPipeline/PhysicalHair/Includes/MarschnerHairForwardPass.hlsl";
            const string kHairSurfaceData       = "Packages/URP-StrandHairShader/Editor/ShaderGraph/UniversalPipeline/PhysicalHair/Includes/MarschnerHairSurfaceData.hlsl";
            const string kHairBSDF              = "Packages/URP-StrandHairShader/Editor/ShaderGraph/UniversalPipeline/PhysicalHair/Includes/MarschnerHairBSDF.hlsl";

            // Custom Varying.hlsl with custom define _LightDirection, that affect the pass of Forward and ShadowCaster only
            const string kVaryings              = "Packages/URP-StrandHairShader/Editor/ShaderGraph/UniversalPipeline/PhysicalHair/Includes/Varyings.hlsl";
